...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_events_per_pixel', default=0.2, type=float,
    ...
    model = E2VIDRecurrent(options)
    device = get_device(args.use_gpu)

    state_dict = torch.load(args.path_to_model, map_location=device)['state_dict']
