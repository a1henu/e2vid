...
class BaseE2VID(BaseModel):
    def __init__(self, config):
        ...
        print('num_bins: {}, num_encoders: {}, base_num_channels: {}, num_residual_blocks: {}, skip_type: {}, norm: {}, use_upsample_conv: {}'.format(
            self.num_bins, self.num_encoders, self.base_num_channels, self.num_residual_blocks, self.skip_type, self.norm, self.use_upsample_conv
        ))
