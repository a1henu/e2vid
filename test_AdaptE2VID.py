...
if __name__ == "__main__":
    ...
    parser.add_argument('-ie', '--input_event', required=True, type=str, help='Path to input event file')
    ...
    with CudaTimer('Processing entire dataset'):
        for event_window in event_iter:
            ...
            with CudaTimer('Building event voxel grid'):
                if inference_config.get('compute_voxel_on_gpu', False):
