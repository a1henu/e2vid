...
f0_path = '/mnt/nas-cp/baichenxu/EvHDR/data/251028_real_data/ap_330-v_1600/outputs/denoised_0.png'
f1_path = '/mnt/nas-cp/baichenxu/EvHDR/data/251028_real_data/ap_330-v_1600/outputs/denoised_1.png'
event_path = '/mnt/nas-cp/baichenxu/EvHDR/data/251028_real_data/ap_330-v_1600/outputs/event_0_1_splits'
...
idx = 0
end_idx = 299
f0 = load_img(f0_path, device)
f1 = load_img(f1_path, device)

evs_filelist = os.listdir(event_path)
evs_filelist = sorted([os.path.join(event_path, f) for f in evs_filelist])
